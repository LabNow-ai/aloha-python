...
- **`pkg/`**: This directory holds the source code for the `aloha` Python package itself. This is the library intended for publication to PyPI. Developers should generally not modify files directly within `pkg/` unless contributing to the `aloha` library.
